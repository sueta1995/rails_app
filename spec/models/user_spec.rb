...
RSpec.describe User, type: :model do
  describe 'test user' do
    let(:second_user) {
      second_user = User.new(nickname: 'tagir1', email: 'tagir1@sueta.com', password: 'Aqwerty123!', password_confirmation: 'Aqwerty123!')
      second_user.save!
    }

    context 'when valid data' do
      it 'returns success' do
        user = User.new(nickname: 'sueta', email: 'sueta@sueta.sueta', password: 'Aa123!', password_confirmation: 'Aa123!')
    ...
    context 'when invalid data' do
      ...
      it 'returns error message, exist nickname' do
        ...
        user = User.new(nickname: 'tagir1', email: 'sueta@sueta.sueta', password: 'Aa123!', password_confirmation: 'Aa123!')
        user.save
      ...
      it 'returns error message, exist email' do
        ...
        user = User.new(nickname: 'sueta', email: 'tagir1@sueta.com', password: 'Aa123!', password_confirmation: 'Aa123!')
        user.save
