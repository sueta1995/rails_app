class PasswordsController < ApplicationController
  ...
  def update
    ...
    if @user.update(nickname: @user.nickname, email: @user.email, password: @password_params[:new_password], password_confirmation: @password_params[:new_password_confirmation])
